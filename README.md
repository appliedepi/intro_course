...
*If you are unable to download, try **[this
link](https://appliedepi-test-website-airspace.netlify.app/files/intro_course.zip)***,
or ask your course organizer for an emailed version.
...
3.  Access Applied Epi course exercises
    </summary>

Ask your instructor for the link to the online interactive exercises. If
you have unreliable internet, ask your instructor for assistance.
...
<!-- **Preferred approach: Copy and paste this command into your R Console as shown below, then press the "Enter" key to run the command:** -->
...
<!-- ```{r, eval = TRUE, echo = FALSE, out.width = "75%"} -->
<!-- knitr::include_graphics("images/README_images/zip_tools_menu.png") -->
<!-- ``` -->
<!-- **In the pop-up window, select "zip" from the first drop-down menu.**   -->
<!-- ```{r, eval = TRUE, echo = FALSE, out.width = "50%"} -->
<!-- knitr::include_graphics("images/README_images/zip_drop_down.png") -->
<!-- ``` -->
...
<!-- ```{r, eval = TRUE, echo = FALSE, out.width = "75%"} -->
<!-- knitr::include_graphics("images/README_images/zip_package_select.png") -->
<!-- ``` -->
</details>
<details markdown=1>
<summary markdown="span" style='text-decoration: underline'>
