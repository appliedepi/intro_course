...
1. [Objective related to demonstrating the topic and purpose of or need for it]
2. [Objective related to demonstrating how the topic is done in R - introducing packages and functions]

# Outline
* Introduction to [topic] in data management
* [The sub-chapters listed here should roughly follow the sub-chapters in the handbook]
* [Consider aggregating the many sub-chapters into a single outline bullet where possible]
* []
* []
