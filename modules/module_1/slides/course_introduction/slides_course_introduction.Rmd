...
outline <- dplyr::tribble(
  ~Module, ~Topic,
  "1",   "RStudio, basic syntax, data import",
  "2",   "Cleaning data, core R functions, piping",
  "3",   "Grouping and summarising data",
  "4",   "Data visualization with ggplot2",
  "5",   "Transforming data with joins and pivots",
  "6",   "Heat plots, epi curves, age/sex pyramids, GIS demo",
  "7",   "R Markdown reports",
  "8",   "COVID-19 exercise",
  )
