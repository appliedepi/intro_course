...
- 150,000 users globally (35,000 in low & middle-income countries)
...
outline <- dplyr::tribble(
  ~Module, ~Date, ~Topic,
  "1", "Mo 4/4",  "RStudio, basic syntax, data import",
  "2", "Mo 4/4",  "Cleaning data, core R functions, piping",
  "3", "Tu 4/5",  "Grouping and summarising data",
  "4", "Tu 4/5",  "Data visualization with ggplot2",
  "5", "We 4/6",  "Transforming data with joins and pivots",
  "6", "We 4/6",  "Heat plots, epi curves, age/sex pyramids, GIS demo",
  "7", "Th 4/7",  "R Markdown reports",
  "8", "Th 4/7",  "COVID-19 exercise",
  )
