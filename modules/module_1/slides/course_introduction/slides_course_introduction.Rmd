...
@MSF @WHO @PIH @USAID @Philly @CalEIS  
</br>

* **Paula Blomquist**  
@PHE @EPIET @WHO @UK-PHRST
</br>
</br>
...
- "I am looking forward to becoming proficient in R as this is the the software used most in our work"
- "I would like to become more confident in using R, writing my own code..."  
- "Capacity to clean a set of data, produce high level descriptive analyses..."  
- "Complex statistical analysis and data visualization"  
- "get more data wrangling practice with epidemiological data"  
- "basic understanding of what it takes to learn R"
...
- "There is a lot to learn. More complicated than STATA."  
- "It can be difficult to work out why the script has not worked."  
...
outline <- dplyr::tribble(
  ~Module, ~Date, ~Topic,
  "1", "Mo 28/3",  "Welcome, RStudio, basic syntax, data import",
  "1", "Mo 28/3",  "Basic syntax, data import",
  "2", "Tu 29/3",  "Cleaning data, core R functions, piping",
  "2", "Tu 29/3",  "Cleaning data, core R functions, piping",
  "3", "We 30/3",  "Grouping and summarising data",
  "4", "We 30/3",  "Data visualization with ggplot2",
  "5", "Th 31/3",  "Transforming data with joins and pivots",
  "6", "Th 31/3",  "Heat plots, epi curves, age/sex pyramids, GIS demo",
  "7", "Fr 1/4",   "R Markdown reports",
  "8", "Fr 1/4",   "COVID-19 exercise",
  )
...
- Each module will end with a plenary debrief.  
- After each day, you will be asked to write answers to reflective questions in the [Applied Epi Community](www.community.appliedepi.org) class thread.  
...
outline <- dplyr::tribble(
  ~Time, ~Location, ~Topic,
  "30 minutes",     "Main",      "Welcome, course logistics, Why R?",
  "20 minutes",     "Main",      "Demo: RStudio tour and basic R syntax",
  "20 minutes",     "Main",      "Functions, packages",
  "20 minutes",     "Main",      "Demo: Functions and packages",
  "1h 30 minutes",  "Breakouts", "Exercise",
...
* Near the end of the course, you will apply your skills to a COVID-19 dataset  
...
- **The exercises are long** - it is OK if you do not finish. We want to know how long they take.  
- **The complete code is available to you** in the "scripts/backup" folder  
