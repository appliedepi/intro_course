...
It should connect the *script* to the *dataset*.
...
But what if your script and data are in different subfolders?  

Normally, to connect the script and the data you would need to use (..) to backtrace 

"../data/clean/linelist.csv"  

And, if you moved your script, this "fragile" path would break.  
...
With {here}, file paths always start from the project **root (top) folder**.  

The path is *relative to* the project root.  

If you move your script, the path does not break.  
...
**From any** location within the R project, this path with find the linelist:  
...
We can send this RStudio project to a colleague, and this command will import the data even if the script is moved in the project.  

```{r, echo=T, eval=F}
import(here("data", "clean", "linelist.csv"))
```

Note: {here} is also agnostic in terms of slash direction ( / on Mac vs. \\ on Windows)  
