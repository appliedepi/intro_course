...
knitr::include_graphics(here::here("images", "logo.png"))
```
...
#### Copy course files into the R project  

In your File Explorer, view the "course_files" folder that we gave to you at the beginning of the course.  

**Copy each sub-folder and file over to the "intro_course" R project.**  
...
* `r emo::ji("folder")` project ("intro_course")  
     ...
     * `r emo::ji("document")` surveillance_linelist_12012014.xlsx
     * intro_course.Rproj  
...
Do you see the file "*surveillance_linelist.xlsx*" that is saved in the "root" project folder? This is the baseline folder - the same folder as the "*intro_course.Rproj*" file. To access the root folder from the R project file you do *not* need to click into any sub-directories (sub-folders).  
