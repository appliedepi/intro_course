...
```{r eval = F, echo=T}
surv_raw <- import("surveillance_linelist_12012014.xlsx")
```
...
You should now see the new object `surv_raw` appear in the R **Environment pane**, under the subcategory "Data". It should say "665 obs. of 19 variables". Congratulations, you have now imported a dataset into R!  
...
```{r, echo=T, eval=F}
surv_raw <- import("C:/Users/Laura/Documents/intro_course/data/surveillance_linelist_12012014.xlsx")
```
...
surv_raw <- import(here("data", "raw", "surveillance_linelist_12012014.xlsx"))
```
...
`r icons::icon_style(icons::fontawesome("window-restore", style = "solid"), scale = 2, fill = "darkgrey")`  
Now, go to your File Explorer to the root folder of the R project. Cut the file *"surveillance_linelist_12012014.xlsx"* from the root folder, and paste it into the "data/raw" subfolder.  


`r icons::icon_style(icons::fontawesome("terminal", style = "solid"), scale = 2, fill = "black")` 
Now in RStudio, write a command to import the "surveillance_linelist_12012014.xlsx" dataset and save it as `surv_raw`.  
