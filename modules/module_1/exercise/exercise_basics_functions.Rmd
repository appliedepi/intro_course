...
```{r, include=FALSE}
# data prep --------------------------------------------------------------------
surv <- rio::import(here::here("data", "surveillance_linelist_12012014.csv"))
```
...
**When finished, view a "solution" below.** We suggest that you align your file names with the solution below.  
