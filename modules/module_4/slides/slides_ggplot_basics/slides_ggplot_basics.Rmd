...
outline <- dplyr::tribble(
  ~Time, ~Location, ~Topic,
  "0900-0930",     "Main",      "{ggplot2} 'Grammar of graphics' syntax",
  "0930-0945",     "Main",      "Live demonstration",
  "1000-1100",     "Breakouts", "Practice making simple plots",
  "1110-1130",     "Main",      "Scales, themes, and labels",
  "1130-1220",     "Breakouts", "Adjusting plots",
  "1220-1230",     "Main",      "Plenary debrief"
)
...
`mapping = aes()` assigns "aesthetics" to columns in the data.  
...
Facets are "small-multiples": tiny plots each for one unique value in a column. 

Faceting can also be used to display groups. 
