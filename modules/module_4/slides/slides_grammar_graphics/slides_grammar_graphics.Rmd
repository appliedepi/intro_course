...
Below, `surv` is aggregated into counts per unique week-hospital  

```{r, eval=F, echo = T, warning=F, message=F}
outcome_week_data <- surv %>% 
* count(hospital,
...
Above, the column `hospital` is **not** provided to any grouping aesthetic.  
