...
* Explore the wide variety of formats and integrations available in R markdown reports  
* Transfer the code you have written for the Ebola case study into an R markdown report  
* Adjust an R markdown to make it conducive to automatically updating with refreshed data  


```{r, echo=FALSE, warning=F, message=F}
outline <- dplyr::tribble(
  ~Time, ~Location, ~Topic,
  "0900-0930",     "Main",      "R markdown demonstration",
  "0930-1000",     "Main",      "R markdown syntax",
  "1000-1200",     "Breakouts", "Create your Ebola situation report",
  "1200-1230",     "Main",      "Plenary debrief"
)
