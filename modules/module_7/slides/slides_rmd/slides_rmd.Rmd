...
* Make an R Markdown script conducive to automatic updates with refreshed data  
...
Within the curly brackets { } at the top of each chunk is:  
- the letter "r" (signifying R code) and a comma ,  
- a chunk name (optional)  
