...
```{r, height = "100%"}
knitr::include_graphics("libs/images/function_tools_pliers.png")
```
...
- A function is like a machine in that:  
     - It receives inputs
     - It does some action with the inputs  
...
```{r, height = "100%"}
knitr::include_graphics("libs/images/Function_Bread_Example.png")
```
