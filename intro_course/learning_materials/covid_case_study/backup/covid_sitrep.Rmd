...
linelist_raw <- import(here("intro_course", "learning_materials", "covid_case_study", "covid_example_data.xlsx"))

city_pops <- import(here("intro_course", "learning_materials", "covid_case_study", "city_pops.xlsx"))
