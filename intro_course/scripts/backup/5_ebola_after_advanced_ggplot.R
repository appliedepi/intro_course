...
# Script after ggplot epi module
###################################
...
hosp_port     <- import(here("data", "raw", "hospitals", "backup", "20141201_hosp_port.csv"))
hosp_smmh     <- import(here("data", "raw", "hospitals", "backup", "20141201_hosp_smmh.csv"))
hosp_missing  <- import(here("data", "raw", "hospitals", "backup", "20141201_hosp_missing.csv"))
...
# Descriptive tables using the surveillance linelist
####################################################
...
# Plots using the surveillance linelist
#######################################
